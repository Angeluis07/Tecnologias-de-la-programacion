...
class Empresa:
    ...
    def listar_empleados_por_jefe(self,o_jefe: 'Jefe') -> None:
        print("Jefe:")
        print(f"Nombre: {o_jefe.nombre}, Apellido: {o_jefe.apellido}")
        print("Empleados: ")
        for trabajador in self.__trabajadores:
            if (isinstance(trabajador, Mensualizado) or isinstance(trabajador, Jornalizado)) and (trabajador.jefe is o_jefe):
                print(f"Nombre: {trabajador.nombre}, Apellido: {trabajador.apellido}")
...
class Mensualizado(Trabajador):
    ...
    def descripcion(self):
        return f"Mensualizado, Categoria: {self.__cat.nombre}"
...
if __name__ == "__main__":
    ...
    jefe_2 = Jefe("Junior","Albarenque","Misiones 577","98000000",3500)
    empleado_1 = Mensualizado("Juan","Quiroga","Av. 264","50000000",categoria_A,jefe_1)
    empleado_2 = Jornalizado("Enrique","Sanchez","Bv. 777","24354882",8,jefe_2)
    ...
    empresa_1.listar_empleados_por_jefe(jefe_1)
